...
export function ProjectPlanningSection({ projectId, onUpdate }: ProjectPlanningSectionProps) {
  ...
  const handleFinalize = async () => {
    if (!projectId) return;
    if (!confirm('Are you sure you want to finalize this setup? This will mark the planning as complete.')) return;
      ...
      <div className="project-setup-summary">
        ...
        <div className="project-setup-actions">
          ...
          <button
            ...
            disabled={saving || allocations.length === 0 || project.setup_status === 'setup_done'}
          >
            ✅ Finalize Setup
          </button>
        </div>
